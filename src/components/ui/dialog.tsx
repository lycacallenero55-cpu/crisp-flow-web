...
>(({ onClick, ...props }, ref) => {
  const handleClick: React.MouseEventHandler<HTMLButtonElement> = (e) => {
    const root = (e.target as HTMLElement).closest('[data-modal-root="dialog"]') as HTMLElement | null
  ...
  return <DialogCloseBase ref={ref} onClick={handleClick} {...props} />
})
